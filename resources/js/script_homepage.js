...
const outlets = {
    surabaya: {
        ...
        address:
            "Jl. Lebak Jaya II No.26, RT.005/RW.04, Gading, Kec. Tambaksari, Surabaya, Jawa Timur 60134",
    ...
    malang: {
        ...
        title: "Outlet Malang",
        address:
            "Jl. Graha Pelita Asri No.b29, Pandanwangi, Kec. Blimbing, Kota Malang, Jawa Timur 65124",
    ...
    denpasar: {
        ...
        address:
            "Gg. Ikan Arwana No.6, Sesetan, Denpasar Selatan, Kota Denpasar, Bali 80224",
...
function setActive(btn) {
    document.querySelectorAll(".outlet-btn").forEach((b) => {
        ...
        // Add scale animation for inactive buttons
    ...
    // Add scale animation for active button
