...
<body class="flex flex-col min-h-screen" style="overflow-x:hidden;">
  ...
  <nav id="navbar"
    ...
    <div class="flex items-center flex-shrink-0 gap-2 pl-2 md:pl-6">
      <img src="{{ asset('assets/homepage/logo.png') }}"
        alt="Logo" class="object-cover w-10 h-10 rounded-full">
    ...
    <div class="flex items-center ml-2 mr-4 md:hidden">
      <button id="hamburger-btn" class="text-white bg-[#8BA870]/80 hover:bg-[#8BA870] focus:outline-none rounded-lg p-2 transition-all duration-200 active:scale-95 active:bg-[#7a965e] transform hover:scale-105">
        <svg class="w-6 h-6 transition-transform duration-200" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
  ...
  <section class="relative w-full h-[400px] md:h-[520px] flex items-center justify-center overflow-hidden">
    <img src="{{ asset('assets/homepage/hero-image.jpg') }}"
      alt="Hero Image" loading="lazy" class="absolute inset-0 object-cover object-center w-full h-full brightness-90">
    <div class="absolute inset-0 z-10 flex flex-col items-center justify-center" data-aos="fade-down">
      ...
      <p class="max-w-2xl mb-8 text-lg font-medium text-center text-white md:text-2xl drop-shadow">Kue Ijo Adalah Kue tradisional Indonesia, cocok untuk semua acara spesial Anda.</p>
      <!-- Kotak dengan 3 tombol WhatsApp Admin -->
      <div class="max-w-md p-3 mx-auto border shadow-lg bg-white/30 backdrop-blur-sm rounded-xl border-white/20 sm:max-w-2xl">
            ...
            <div x-data="{ open: false }">
              <p class="mb-8 leading-relaxed text-gray-600">
                <div x-show="!open" class="text-justify">
                  Kue Pandan Asli, kami adalah perusahaan kuliner yang berfokus pada produksi dan pengembangan kue tradisional berbahan alami tanpa bahan pengawet, tanpa pewarna tambahan, tanpa pengharum tambahan dan tanpa pemanis buatan. Kami berfokus pada bahan bahan alami mulai dari pewarna kami menggunakan 100% pandan pada seluruh produk kami. Kami berkomitmen menghadirkan kue tradisional dengan bahan baku premium, alami dan kekinian.<br>
                  <button @click="open = true" class="inline-flex items-center gap-2 bg-[#8BA870] text-white px-4 py-1.5 rounded-full font-semibold shadow hover:bg-[#7a965e] transition mt-8 group">
                    <svg class="w-4 h-4 text-white transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          ...
          <div x-show="tab === 'misi'" x-transition:enter="transition ease-out duration-800" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-400" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
            ...
            <ul class="pl-6 mb-8 space-y-2 leading-relaxed text-gray-600 list-disc">
              <li class="text-justify">
                <span class="font-semibold text-[#8BA870]">Mengutamakan bahan alami:</span> Seluruh produk dibuat dari bahan baku alami, tanpa bahan pengawet, tanpa pewarna tambahan, tanpa pengharum tambahan dan tanpa pemanis buatan.
              </li>
              <li class="text-justify">
  ...
  <section id="produk-kami" class="w-full pt-4 pb-8 bg-white">
    ...
    <div class="w-[90%] max-w-7xl mx-auto"
      ...
      <div class="flex flex-wrap justify-center gap-2 mb-4 md:gap-4">
        ...
        <button @click="kategori = 'semua'" :class="kategori === 'semua' ? 'bg-[#8BA870] text-white' : 'bg-gray-100 text-[#2C3E50]'" class="px-5 py-2 font-semibold transition rounded-full shadow">Semua</button>
        <button @click="kategori = 'produk'" :class="kategori === 'produk' ? 'bg-[#8BA870] text-white' : 'bg-gray-100 text-[#2C3E50]'" class="px-5 py-2 font-semibold transition rounded-full shadow">Ala Carte</button>
        <button @click="kategori = 'hampers'" :class="kategori === 'hampers' ? 'bg-[#8BA870] text-white' : 'bg-gray-100 text-[#2C3E50]'" class="px-5 py-2 font-semibold transition rounded-full shadow">Hampers</button>
        <button @click="kategori = 'tumpeng'" :class="kategori === 'tumpeng' ? 'bg-[#8BA870] text-white' : 'bg-gray-100 text-[#2C3E50]'" class="px-5 py-2 font-semibold transition rounded-full shadow">Tumpeng</button>
      </div>
      ...
      <div x-show="kategori === 'semua' || kategori === 'produk'"
        ...
        <div
          class="relative transition-all duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl hover:-translate-y-1"
          data-aos="zoom-in"
          x-data="{
          open: false,
          prices: [
          ...
          <div class="relative overflow-hidden rounded-t-2xl">
            ...
            <div class="absolute px-2 py-1 text-xs font-medium text-white bg-orange-500 rounded-full top-3 right-3">
              Ala Carte
            </div>
          </div>
          <div class="p-5">
                ...
                <div x-show="open"
                  ...
                  <ul>
                    <template x-for="price in prices" :key="price.label">
                      <li @click="selectedPrice = price; open = false" class="p-3 cursor-pointer hover:bg-gray-100">
        ...
        <div
          ...
          <div class="p-5">
            ...
            <div x-data="{ open: false }">
              <p class="mb-3 text-sm text-justify text-gray-600" :class="open ? '' : 'line-clamp-2'">
                Kue Pulut yang dibuat dari beras ketan utuh yang akan menciptakan tekstur punel dan sedikit legit. Perpaduan warna Putih dari beras ketan dan Ungu alami dari bunga telang (butterfly pea tea) menambah keindahan visual pada kue ini. Kue Pulut ini dilengkapi dengan saus srikaya yang membuat perpaduan antara manis dan sedikit gurih dari saus dan gurih dari kue pulut itu sendiri menjadikan perpaduan rasa yang lengkap dan lezat.
              </p>
              <button @click="open = !open" class="text-[#8BA870] text-xs font-semibold focus:outline-none hover:underline mb-2">
                <span x-show="!open">Selengkapnya</span>
                <span x-show="open">Tutup</span>
        ...
        <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl hover:-translate-y-1" data-aos="zoom-in">
          <div class="relative overflow-hidden rounded-t-2xl">
          ...
          <div class="p-5">
            ...
            <div x-data="{ open: false }">
              <p class="mb-3 text-sm text-justify text-gray-600" :class="open ? '' : 'line-clamp-2'">
                Kue Ubi Nanas Adalah Kue yang terbuat dari Singkong atau ubi kayu yang empuk dan dikombinasi dengan buah nanas serta ditaburi parutan kelapa.
              </p>
              <button @click="open = !open" class="text-[#8BA870] text-xs font-semibold focus:outline-none hover:underline mb-2">
                <span x-show="!open">Selengkapnya</span>
                <span x-show="open">Tutup</span>
        ...
        <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl hover:-translate-y-1" data-aos="zoom-in">
          ...
          <div class="p-5">
            ...
            <div x-data="{ open: false }">
              <p class="mb-3 text-sm text-justify text-gray-600" :class="open ? '' : 'line-clamp-2'">
                Selai yang terbuat dari perpaduan santan kelapa, telur, air pandan yang menghasilkan rasa yang gurih dan manis pada selai ini. Selai yang memiliki tekstur kental dan memiliki warna oren pekat dihasilkan dari telur. Selai itu cocok dipadukan dengan kue yang memiliki cita rasa netral maupun gurih untuk menambahkan cita rasa manis pada rasa kue tersebut.
              </p>
              <button @click="open = !open" class="text-[#8BA870] text-xs font-semibold focus:outline-none hover:underline mb-2">
                <span x-show="!open">Selengkapnya</span>
                <span x-show="open">Tutup</span>
      ...
      <div x-show="kategori === 'semua' || kategori === 'hampers'"
        ...
        <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl hover:-translate-y-1" data-aos="zoom-in">
          <div class="relative overflow-hidden rounded-t-2xl">
            <img src="{{ asset('assets/homepage/product/hampers-a.jpg') }}" alt="Hampers A (Anggun)" loading="lazy" class="object-cover w-full h-48 transition-transform duration-300 hover:scale-105 cursor-zoom-in zoomable">
          ...
          <div class="p-5">
            ...
            <p class="mb-3 text-sm text-justify text-gray-600">Berisi: Kue Ijo (12 pcs), Kue Ongol-ongol (30 pcs), Kue Pulut Srikaya (10 pcs), Lumpur Surga (4 cup @100ml).</p>
            <div class="flex items-center justify-between">
        ...
        <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl hover:-translate-y-1" data-aos="zoom-in">
          <div class="relative overflow-hidden rounded-t-2xl">
            <img src="{{ asset('assets/homepage/product/hampers-b.jpg') }}" alt="Hampers B (Bagus)" loading="lazy" class="object-cover w-full h-48 transition-transform duration-300 hover:scale-105 cursor-zoom-in zoomable">
            <div class="absolute top-3 right-3 bg-[#7079a8] text-white px-2 py-1 rounded-full text-xs font-medium">Hampers</div>
          </div>
          <div class="p-5">
            <h3 class="font-bold text-lg text-[#2C3E50] mb-2">Hampers B (Bagus)</h3>
            <p class="mb-3 text-sm text-justify text-gray-600">Berisi: Kue Ijo (12 pcs), Kue Ongol-ongol (30 pcs), Kue Pulut Srikaya (10 pcs).</p>
            <div class="flex items-center justify-between">
        ...
        <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl hover:-translate-y-1" data-aos="zoom-in">
          <div class="relative overflow-hidden rounded-t-2xl">
            <img src="{{ asset('assets/homepage/product/hampers-c.png') }}" alt="Hampers C (Cantik)" loading="lazy" class="object-cover w-full h-48 transition-transform duration-300 hover:scale-105 cursor-zoom-in zoomable">
            <div class="absolute top-3 right-3 bg-[#7079a8] text-white px-2 py-1 rounded-full text-xs font-medium">Hampers</div>
          </div>
          <div class="p-5">
            <h3 class="font-bold text-lg text-[#2C3E50] mb-2">Hampers C (Cantik)</h3>
            <p class="mb-3 text-sm text-justify text-gray-600 line-clamp-2">BELUM ADA DATA</p>
            <div class="flex items-center justify-between">
      ...
      <div x-show="kategori === 'semua' || kategori === 'tumpeng'"
        ...
        <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl hover:-translate-y-1" data-aos="zoom-in">
          <div class="relative overflow-hidden rounded-t-2xl">
            <img src="{{ asset('assets/homepage/product/tumpeng-mini.jpg') }}" alt="Tumpeng Mini" loading="lazy" class="object-cover w-full h-48 transition-transform duration-300 hover:scale-105 cursor-zoom-in zoomable">
            <div class="absolute px-2 py-1 text-xs font-medium text-white bg-yellow-500 rounded-full top-3 right-3">Tumpeng</div>
          </div>
          <div class="p-5">
            <h3 class="font-bold text-lg text-[#2C3E50] mb-2">Tumpeng Mini Mix</h3>
            <p class="mb-3 text-sm text-justify text-gray-600 ">Berisi: Kue Ijo (25 pcs), Kue Pulut (20 pcs), Kue Ongol-ongol (50 pcs), Lumpur Surga (6 cup). Tumpeng mini mix ini cocok untuk syukuran, ulang tahun, atau acara spesial lainnya.</p>
            <div class="flex items-center justify-between">
        ...
        <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl hover:-translate-y-1" data-aos="zoom-in">
          <div class="relative overflow-hidden rounded-t-2xl">
            <img src="{{ asset('assets/homepage/product/tumpeng-besar.jpg') }}" alt="Tumpeng Besar" loading="lazy" class="object-cover w-full h-48 transition-transform duration-300 hover:scale-105 cursor-zoom-in zoomable">
            <div class="absolute px-2 py-1 text-xs font-medium text-white bg-yellow-500 rounded-full top-3 right-3">Tumpeng</div>
          </div>
          <div class="p-5">
            <h3 class="font-bold text-lg text-[#2C3E50] mb-2">Tumpeng Besar Mix</h3>
            <p class="mb-3 text-sm text-justify text-gray-600">Berisi: Kue Ijo (50 pcs), Kue Pulut (40 pcs), Kue Ongol-ongol (100 pcs), Lumpur Surga (12 cup). Tumpeng besar mix untuk acara keluarga, kantor, arisan, atau perayaan penting lainnya.</p>
            <div class="flex items-center justify-between">
    ...
    <div class="w-[90%] max-w-7xl mx-auto">
      ...
      <div class="relative" data-aos="zoom-out-down">
              ...
              <div class="overflow-hidden bg-white shadow-lg rounded-2xl">
                <div class="flex flex-col md:flex-row min-h-[450px]">
                  ...
                  <div class="w-full md:w-2/3 lg:w-3/4 p-8 md:p-12 flex flex-col justify-center bg-gradient-to-r from-transparent to-[#8BA870]/5">
                    ...
                    <blockquote class="relative mb-6 text-lg italic leading-relaxed text-gray-700 md:text-xl">
                    ...
                    <!-- Star Rating -->
                    <div class="p-3 border border-gray-200 rounded-lg shadow-sm bg-white/80 backdrop-blur-sm">
        ...
        <div class="flex justify-center gap-2 mt-6">
          ...
          <button class="w-3 h-3 transition-all duration-300 bg-gray-300 rounded-full testimonial-dot hover:bg-gray-400" data-slide="1"></button>
          <button class="w-3 h-3 transition-all duration-300 bg-gray-300 rounded-full testimonial-dot hover:bg-gray-400" data-slide="2"></button>
          <button class="w-3 h-3 transition-all duration-300 bg-gray-300 rounded-full testimonial-dot hover:bg-gray-400" data-slide="3"></button>
          <button class="w-3 h-3 transition-all duration-300 bg-gray-300 rounded-full testimonial-dot hover:bg-gray-400" data-slide="4"></button>
          <button class="w-3 h-3 transition-all duration-300 bg-gray-300 rounded-full testimonial-dot hover:bg-gray-400" data-slide="5"></button>
          <button class="w-3 h-3 transition-all duration-300 bg-gray-300 rounded-full testimonial-dot hover:bg-gray-400" data-slide="6"></button>
          <button class="w-3 h-3 transition-all duration-300 bg-gray-300 rounded-full testimonial-dot hover:bg-gray-400" data-slide="7"></button>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="w-[90%] max-w-5xl mx-auto">
      ...
      <div id="outlet-content" data-aos="fade-up"
        ...
        <div class="flex flex-col w-full gap-4 md:w-1/2">
          ...
          <p id="outlet-address" class="mb-1 text-gray-700">Jalan Lebak Jaya II no. 26A Gading, Tambaksari, Surabaya, Jawa Timur 60134 (Rumah pagar hitam)</p>

          <!-- Jam Buka -->
          <p id="outlet-hours-info" class="flex items-center gap-2 mb-1 text-sm text-gray-500">
            <i class="text-lg fas fa-calendar-days"></i> <span id="outlet-hours-text">Buka Setiap Hari, 06.00 - 23.00</span>
          </p>
          ...
          <div class="flex items-center gap-4 text-gray-600">
            ...
            <div class="flex items-center gap-4 text-base">
              <a id="social-tiktok" href="#" target="_blank" class="transition hover:text-black" aria-label="TikTok">
                <i class="fab fa-tiktok"></i>
              </a>
              <a id="social-instagram" href="#" target="_blank" class="transition hover:text-pink-500" aria-label="Instagram">
                <i class="fab fa-instagram"></i>
              </a>
              <a id="social-facebook" href="#" target="_blank" class="transition hover:text-blue-600" aria-label="Facebook">
      ...
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="/" class="flex flex-col items-start">
            <img src="{{ asset('assets/homepage/logo.png') }}" alt="Logo" class="object-cover w-8 h-8 mb-2 rounded-full">
            <span class="text-2xl font-semibold text-left whitespace-nowrap">Kue Pandan Asli</span>
          </a>
          <p class="max-w-xs mt-2 text-sm text-gray-400">Kue Pandan Asli, kami adalah perusahaan kuliner yang berfokus pada produksi dan pengembangan kue tradisional berbahan alami tanpa campuran pengawet dan pewarna.</p>
        </div>
