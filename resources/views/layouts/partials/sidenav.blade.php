    ...
    <a id="sidebar-logo-link" class="flex items-center block px-8 py-6 m-0 text-base whitespace-nowrap dark:text-white text-slate-700"
        ...
        <div class="flex-grow w-full overflow-y-auto">
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="w-full mt-4 mb-4">
                    <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase sidenav-text dark:text-white opacity-60">Account Pages
                    </h6>
                </li>
                <li class="mt-0.5 w-full">
        ...
        <div class="flex-shrink-0 p-4 mx-4">
            ...
            <a href="javascript:;" class="items-center justify-center hidden w-full p-3 text-white rounded-full xl:flex bg-greenlight hover:bg-black dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-black focus:outline-none" sidenav-trigger>
