<aside
    ...
    <div class="h-19">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap dark:text-white text-slate-700" href="{{ $dashboardUrl }}">
            <img src="{{ asset('assets/homepage/logo.png') }}" class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand text-greenlight">Kue Pandan Asli</span>
        </a>
    </div>
