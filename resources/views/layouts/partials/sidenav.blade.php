...
<div class="flex-shrink-0 h-19">
    ...
    <a id="sidebar-logo-link" class="flex items-center block px-8 py-6 m-0 text-base whitespace-nowrap dark:text-white text-slate-700"
        ...
        <div class="flex-shrink-0 p-4 mx-4">
            ...
            <a href="javascript:;" class="hidden xl:flex items-center justify-center w-full p-3 text-white bg-greenlight rounded-full hover:bg-black dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-black focus:outline-none" sidenav-trigger>
