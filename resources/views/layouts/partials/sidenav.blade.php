<aside
    ...
    @auth
        ...
        <div class="h-19">
            ...
            <a class="flex items-center block px-8 py-6 m-0 text-base whitespace-nowrap dark:text-white text-slate-700"
                href="{{ $dashboardUrl }}">
                <img src="{{ asset('assets/homepage/logo.png') }}"
                    class="w-auto h-8 transition-all duration-200 ease-nav-brand" alt="main_logo" />
                <span class="ml-2 text-xl font-semibold transition-all duration-200 ease-nav-brand text-greenlight">
                    Kue Pandan Asli
                </span>
            </a>
        </div>
        ...
        <div class="items-center block w-auto max-h-screen h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="w-full mt-4 mb-4">
                    <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase dark:text-white opacity-60">Dashboard Pages
                    </h6>
                </li>
                ...
                @role('admin')
                    ...
                    <li class="w-full mt-4 mb-4">
                        <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase dark:text-white opacity-60">Performa
                            Pages
                        </h6>
                    </li>
                    ...
                    <li class="mt-0.5 w-full">
                        <a class="dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                            ...
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Performa Customer</span>
                        </a>
                    </li>
                    ...
                    <li class="mt-0.5 w-full">
                        <a class="dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                            ...
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Performa Kurir</span>
                        </a>
                    </li>
