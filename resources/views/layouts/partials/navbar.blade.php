  ...
  <div class="flex flex-wrap items-center justify-between w-full px-4 py-1 mx-auto"> --}}
        ...
        @endauth --}}
                ...
                <li class="relative flex items-center px-2 group">
                    ...
                    <div
                        class="absolute right-0 z-50 w-64 mt-40 transition duration-200 ease-out origin-top-right scale-95 bg-white rounded-md shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 group-hover:scale-100 group-hover:pointer-events-auto">
                        <div class="px-4 py-2 text-sm text-gray-700 border-b">
                            @php
                                ...
                                $lastLogin = $lastSession
                                    ? \Carbon\Carbon::createFromTimestamp($lastSession->last_activity)
                        ...
                        @endphp
                        <a href="{{ $profileUrl }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">My
                            Profile</a>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
