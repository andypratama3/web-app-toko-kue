            ...
            <div class="space-y-4 md:hidden">
                @forelse ($orders as $order)
                    <div class="p-4 rounded-lg shadow bg-gray-50 dark:bg-gray-700">
                        ...
                        <div class="flex items-start justify-between pb-3 border-b dark:border-gray-600">
                            <div>
                                <p class="text-sm font-bold text-gray-900 dark:text-white">{{ $order->invoice_number }}</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    {{ $order->created_at->isoFormat('D MMM YYYY, HH:mm') }}</p>
                            </div>
                            <button type="button"
                        ...
                        <div class="flex items-start justify-between mt-4">
                            ...
                            <div class="pr-4">
                                ...
                                <p class="text-xs text-gray-600 dark:text-gray-300">{{ $order->customer->address ?? '' }}
                                </p>
                            </div>
