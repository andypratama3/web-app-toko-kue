                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col"
                                    class="w-[45%] px-6 py-3 text-xs font-bold tracking-wider text-left text-gray-500 uppercase dark:text-white">
                                    📦 Produk
                                </th>
                                <th scope="col"
                                    class="w-[30%] px-6 py-3 text-xs font-bold tracking-wider text-center text-gray-500 uppercase dark:text-white">
                                    Jumlah Diretur
                                </th>
                                <th scope="col"
