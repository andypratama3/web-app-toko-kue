...
<x-modal-custom id="returnProductModal" title="Pilih Produk untuk Pengembalian" size="2xl">
    ...
    <div id="returnModalLoader" class="text-center">
        <svg class="w-8 h-8 text-blue-600 animate-spin mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 24 24">
    ...
    <div id="returnModalContent" class="hidden">
        <form id="returnProductForm" class="flex flex-col h-full">
            ...
            {{-- Menghapus max-h-[60vh] karena tinggi modal sudah diatur oleh modal-custom.blade.php --}}
            <div id="returnProductList" class="space-y-3 mb-4 pr-2 sm:pr-4">
            </div>

            {{-- Footer diletakkan di slot footer untuk posisi yang paten --}}
            <div class="flex justify-end p-4 space-x-3 border-t border-gray-200 dark:border-gray-600">
                {{-- DIUBAH: Menggunakan class js-close-modal-btn, menghapus data-modal-hide --}}
                <button type="button"
                ...
                <button type="submit" id="submitReturnRequestButton"
