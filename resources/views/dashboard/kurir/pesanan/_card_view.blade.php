...
<div class="relative p-3 overflow-hidden bg-white shadow-lg rounded-xl dark:bg-gray-700"
    ...
    <div class="pl-2">
        ...
        <div class="flex justify-end pt-2 space-x-2 border-t border-gray-200 dark:border-gray-600">
            ...
            <button type="button"
                class="js-open-details-modal px-2 py-1 text-xs font-medium text-gray-900 bg-gray-200 rounded-lg hover:bg-gray-300 transition-colors dark:bg-slate-600 dark:text-gray-100 dark:hover:bg-slate-500"
                data-order-id="{{ $order->id }}">
                Rincian
            </button>
        </div>
