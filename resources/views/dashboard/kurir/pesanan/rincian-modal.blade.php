<x-modal-custom id="orderDetailsModal" title="Rincian Pesanan" size="3xl">
    ...
    <div id="modalContent" class="hidden space-y-3">
        ...
        <div class="grid grid-cols-1 gap-2 sm:gap-4 pt-2 sm:pt-4 border-t sm:grid-cols-2 dark:border-gray-600">
            <div>
                <h4 class="mb-1 text-base sm:text-md font-semibold text-gray-800 dark:text-white">💰 Detail Pembayaran
                </h4>
                <p class="text-sm text-gray-700 dark:text-gray-300">Metode : <span class="uppercase font-bold"
                        id="paymentMethod"></span></p>
            </div>
            <div>
                <h4 class="mb-1 text-base sm:text-md font-semibold text-gray-800 dark:text-white">🚚 Detail Pengiriman
                </h4>
        ...
        <div class="pt-2 sm:pt-4 border-t dark:border-gray-600">
            <details id="productSection" class="block sm:open" open>
                <summary class="sm:hidden font-semibold text-gray-800 dark:text-white cursor-pointer py-2">🛒 Produk
                    Dipesan</summary>
                <div class="px-2 py-1 sm:px-0">
                    <h4 class="mb-2 text-base sm:text-md font-semibold text-gray-800 dark:text-white hidden sm:block">🛒
                        Produk Dipesan</h4>
        ...
        <div class="pt-2 sm:pt-4 border-t dark:border-gray-600">
            <details id="paymentProofSection" class="block sm:open" open>
                <summary class="sm:hidden font-semibold text-gray-800 dark:text-white cursor-pointer py-2">Bukti
                    Pembayaran/Retur</summary>
                <div class="px-2 py-1 sm:px-0">
                    <h4 id="paymentProofTitle"
                        class="mb-2 text-base sm:text-md font-semibold text-gray-800 dark:text-white hidden sm:block">
                        Bukti Pembayaran</h4>
                    ...
                    <form id="paymentUploadForm" class="hidden" enctype="multipart/form-data">
                        ...
                        <a id="compress-link" href="https://gentle-druid-f8b395.netlify.app/" target="_blank"
                            ...
                            class="hidden flex items-center gap-2 mb-3 text-sm text-blue-600 hover:underline dark:text-blue-400">
                            <i class="fas fa-compress"></i>
                            <span>klik untuk compress gambar</span>
                        </a>
                        <button type="submit"
                            ...
                            <svg id="uploadButtonSpinner" class="hidden w-4 h-4 text-white animate-spin"
                    ...
                    <div id="paymentProofUploaded" class="hidden text-center">
                        ...
                        <img id="proofImage" src="" alt="Bukti Unggahan"
                            class="object-contain w-full max-w-xs mx-auto border rounded-lg shadow-md cursor-pointer h-auto max-h-48 dark:border-gray-600"
                    ...
                    <div id="paymentUploadBlocker" class="hidden p-3 text-center bg-yellow-100 rounded-lg">
                        <p class="font-semibold text-yellow-800 text-base">Status pesanan tidak memungkinkan untuk
                            unggah bukti saat ini.</p>
                    </div>
                </div>
            </details>
        </div>
...
<div id="imageViewerModal"
    class="fixed inset-0 z-[9999] flex items-center justify-center w-full h-full bg-black bg-opacity-80 hidden"
    onclick="closeImageViewer()">
    <img id="fullSizeImage" src="" class="max-w-[90vw] max-h-[90vh] object-contain">
    <button class="absolute text-3xl font-bold text-white top-4 right-6"
