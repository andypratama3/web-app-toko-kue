<x-modal-custom id="orderDetailsModal" title="Rincian Pesanan" size="4xl">
    ...
    <div id="modalContent" class="hidden">
        <div class="grid grid-cols-1 gap-6 p-1 lg:grid-cols-3">
                ...
                <div class="p-5 bg-white border border-gray-200 shadow-md dark:bg-gray-800 rounded-xl dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                        <div>
                            ...
                            <p id="modalInvoiceNumber" class="font-mono text-lg font-semibold text-gray-800 dark:text-gray-200"></p>
                        </div>
                        <div>
            ...
            <div class="space-y-6 lg:col-span-1">
                ...
                <div class="p-5 bg-white border border-gray-200 shadow-md dark:bg-gray-800 rounded-xl dark:border-gray-700">
                    <div class="mb-5">
                        <label class="block mb-2 text-sm font-medium text-gray-500 dark:text-gray-400">Status Pesanan</label>
                    ...
                    <div id="totalAmountSection" class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div id="returnedTotalAmountContainer" class="hidden">
                            ...
                            <p id="modalInitialTotalAmount" class="text-sm font-bold text-gray-400 line-through dark:text-gray-500"></p>
                ...
                <div class="p-5 bg-white border border-gray-200 shadow-md dark:bg-gray-800 rounded-xl dark:border-gray-700">
                    <h3 id="paymentProofTitle" class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Bukti Pembayaran</h3>
                    ...
                    <form id="paymentUploadForm" class="hidden space-y-3" enctype="multipart/form-data">
                        ...
                        <a id="compress-link" href="https://gentle-druid-f8b395.netlify.app/" target="_blank" rel="noopener noreferrer" class="items-center hidden gap-2 text-sm text-blue-600 hover:underline dark:text-blue-400">
  ...
  <span>Kompres gambar</span>
                    ...
                    <div id="paymentProofUploaded" class="hidden text-center">
                        ...
                        <img id="proofImage" src="" alt="Bukti Unggahan" class="object-cover w-full h-auto mx-auto border-2 border-gray-200 rounded-lg shadow-md cursor-pointer dark:border-gray-600 max-h-48" onclick="openImageViewer(this.src)">
                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Klik gambar untuk memperbesar.</p>
                    </div>

                    <div id="paymentUploadBlocker" class="hidden p-4 text-center bg-yellow-100 rounded-lg dark:bg-yellow-900/20">
                        <p class="text-sm font-medium text-yellow-800 dark:text-yellow-300">Status pesanan tidak memungkinkan untuk unggah bukti saat ini.</p>
                    </div>
                </div>

                <div id="returnRequestButtonContainer" class="hidden">
                    <button type="button" id="requestReturnButton" class="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-white transition-colors bg-red-600 rounded-lg js-open-modal-btn group hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300" data-target-modal="returnProductModal">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 transition-transform transform group-hover:-translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
