...
<div class="flex-auto p-3 pt-0 -mx-3">
    <div class="p-2.5 bg-white shadow-md rounded-xl dark:bg-gray-800 dark:border-gray-700 min-h-[715px]">
        ...
        <div class="flex flex-col items-center justify-between mb-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
            ...
            <div class="w-full xl:hidden flex items-center p-1 space-x-1 overflow-x-auto text-sm text-gray-600 bg-gray-200 rounded-lg dark:bg-gray-900/50">
                ...
                <a href="{{ route('kurir.pesanan.index', array_merge(request()->except('page'), ['status' => $key == 'semua' ? null : $key])) }}"
                    class="flex-shrink-0 px-3 py-1.5 font-medium rounded-md whitespace-nowrap
                              @if ((empty($activeStatus) && $key == 'semua') || $activeStatus == $key)
                                  bg-white text-blue-600 shadow dark:bg-gray-700 dark:text-white
                              @else
                                  hover:bg-white/60 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700/50 dark:hover:text-white
                              @endif
                       ">
                    {{ $label }}
                </a>
        ...
        <div class="hidden overflow-x-auto md:block">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase dark:text-gray-300">
                            <div class="flex items-center">
                                ...
                                <a href="#" data-dropdown-toggle="filter-dropdown-table" class="ml-3">
                                    <i class="fas fa-filter text-gray-400 hover:text-gray-600"></i>
                                </a>
                            </div>
                        </th>
                ...
                <tbody id="orders-desktop-container" class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    @include('dashboard.kurir.pesanan._table_rows', compact('orders', 'statusLabelMap'))
                </tbody>
            </table>
        </div>
                        ...
                        <div class="flex items-start gap-4 p-2 mx-0 border-b border-gray-200 dark:border-gray-700" data-return-key="${returnKey}">
                            ...
                            <div class="flex flex-col flex-1">
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <button type="button" class="remove-product text-xl text-red-600 hover:text-red-900" title="Setel kuantitas ke 0">🗑</button>
                                </div>
