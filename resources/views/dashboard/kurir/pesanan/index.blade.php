    ...
    <script>
        ...
        async function handleStatusUpdate() {
            ...
            try {
                ...
                // 2. Buat formatter khusus untuk zona waktu 'Asia/Jakarta' dengan format Indonesia
                const formatter = new Intl.DateTimeFormat('id-ID', {
                    timeZone: 'Asia/Jakarta', // Kunci utamanya ada di sini!
                    day: 'numeric',
                    month: 'long',
                    year: 'numeric',
                    hour: '2-digit',
                ...
                const jakartaTimestamp = formatter.format(now);

                // 4. Perbarui teks timestamp di UI stepper
                const timeSpanId = {
                    'diambil': 'pickedUpAt',
                    'diantar': 'deliveredAt',
                    'diterima_pembeli': 'receivedByBuyerAt'
                ...
                if (timeSpanId) {
                    // Tampilkan waktu Jakarta yang sudah diformat
                    document.getElementById(timeSpanId).textContent = jakartaTimestamp;
                }
