    ...
    <div class="w-full max-w full">
        <div class="flex flex-wrap gap-6 -mx-3">
            <div class="w-full max-w-full px-3 space-y-4 lg:flex-nome">
                <div class="mb-6 ">
                    <div class="flex flex-col flex-none max-w-full gap-4 p-5 px-4 py-4 shadow rounded-2xl xl:gap-0"
                        style="background-color: #efece8ff; ">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <a href="{{ route('kurir.pesanan.create') }}" class="w-1/2 px-3 ">
                            <div
                                ...
                                <div
                                    class="flex items-center justify-center w-12 h-6 mr-2 bg-green-100 rounded-full lg:mr-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" viewBox="0 0 24 24"
                                        fill="#fde047" stroke="#000">
                        ...
                        <button type="button" id="add-customer"
                            ...
                            <div
                                class="flex items-center p-4 transition duration-150 ease-in-out transform bg-white shadow-lg rounded-2xl hover:shadow-xl active:scale-95">
                                <div
                                    class="flex items-center justify-center w-12 h-6 mr-2 bg-yellow-100 rounded-full lg:mr-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" viewBox="0 0 24 24"
                                        fill="#fde047" stroke="#000">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:flex-none">
                <div
                    ...
                    <div class="p-4 pb-4 mb-0 rounded-t-4">
                        <div class="flex-1">

                            {{-- PENAMBAHAN KODE DIMULAI DI SINI --}}

                            {{-- Kita menggunakan Auth::user()->note yang merupakan cara mudah mendapatkan note dari kurir yang login --}}
                            @if (Auth::user()->note)
                                {{-- Judul Section --}}
                                <div class="flex items-center">
                                    <i class="mr-2 text-lg text-yellow-500 fas fa-sticky-note"></i>
                                    <h6 class="mb-0 font-bold dark:text-white">Catatan dari Admin</h6>
                                </div>

                                {{-- Isi Catatan --}}
                                <p class="mt-2 text-sm leading-normal text-slate-700 dark:text-slate-300">
                                    "{{ Auth::user()->note }}"
                                </p>
                            @else
                                {{-- Pesan jika tidak ada catatan --}}
                                <div class="flex items-center">
                                    <i class="mr-2 text-lg text-green-500 fas fa-check-circle"></i>
                                    <h6 class="mb-0 font-bold dark:text-white">Tidak Ada Catatan Baru</h6>
                                </div>
                                <p class="mt-2 text-sm leading-normal text-slate-700 dark:text-slate-300">
        ...
        <div class="flex flex-wrap mt-6 -mx-3">
            <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
                <div
                    class="relative flex flex-col min-w-0 mb-4 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                        ...
                        <div class="p-0 overflow-x-auto">
                            <table
                                ...
                                <thead class="text-black align-bottom">
                                    <tr>
                                        <th
                                            class="px-6 py-3 font-bold text-left text-black uppercase align-middle bg-transparent border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                            Nama</th>
                                        <th
                                            class="px-6 py-3 pl-2 font-bold text-left text-black uppercase align-middle bg-transparent border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                            Alamat</th>
                                        <th
                                            class="px-6 py-3 font-bold text-center text-black uppercase align-middle bg-transparent border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                            Pesanan</th>
                                        <th
                                            class="px-6 py-3 font-bold text-center text-black uppercase align-middle bg-transparent border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                            Status</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td
                                            class="p-2 bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <span
                                                class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400">Tumpeng
                                                Kue Pandan</span>
                                        </td>
                                        <td
                                            class="p-2 text-sm leading-normal text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <span
                                                class="bg-gradient-to-tl from-emerald-500 to-teal-400 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">TERKIRIM</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                        ...
                                        <td
                                            class="bg-transparent border-b p-2r dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <span
                                                class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400">Kue
                                                Manis</span>
                                        </td>
                                        <td
                                            class="p-2 text-sm leading-normal text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <span
                                                class="bg-gradient-to-tl from-red-600 to-red-400 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">Gagal</span>
                                        </td>
