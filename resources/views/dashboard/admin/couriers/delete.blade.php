{{-- resources/views/dashboard/admin/couriers/modals/delete.blade.php --}}
@props(['courier'])

<x-modal-custom id="delete-courier-modal-{{ $courier->id }}" title="Konfirmasi Hapus" toggle="delete-courier-modal-{{ $courier->id }}" size="md">
