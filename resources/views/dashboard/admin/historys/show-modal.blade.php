            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <div class="p-5 bg-white border border-gray-200 shadow-md dark:bg-gray-800 rounded-xl dark:border-gray-700">
                    ...
                    <div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="p-3 mt-1 text-sm text-gray-700 bg-yellow-100 border border-yellow-200 rounded-lg dark:bg-yellow-900/20 dark:text-yellow-200 dark:border-yellow-800/50">
...
<div id="showOrderModalZoomWrapper-admin" class="fixed inset-0 z-[9999] items-center justify-center hidden bg-black bg-opacity-80">
    <img id="showOrderModalZoomImg-admin" src="" alt="Zoomed Image" class="max-w-[90%] max-h-[90%] border-4 border-white rounded shadow-lg">
</div>
