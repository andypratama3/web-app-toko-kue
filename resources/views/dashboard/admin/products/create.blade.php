...
<x-modal-custom id="create-product-modal" title="Tambah Produk Baru" toggle="create-product-modal" size="4xl">
        ...
        <div class="p-4 md:p-5">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    ...
                    <div id="create-variants-container">
                        @if (old('variants'))
                    ...
                    <button type="button" id="add-create-variant-btn" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Tambah Varian</button>
                </div>
            </div>

            <div class="flex items-center justify-end pt-4 mt-4 border-t">
                <button type="submit" class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Simpan Produk</button>
            </div>
        </div>
    </form>
</x-modal-custom>

{{-- SCRIPT LENGKAP UNTUK MODAL CREATE --}}
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const setupCreateVariantLogic = () => {
            ...
            // LOGIKA HAPUS VARIAN DIPINDAHKAN KE SINI
