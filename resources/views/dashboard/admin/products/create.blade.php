    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-4 md:p-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" id="create-name" value="{{ old('name') }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-100 dark:placeholder-gray-400"
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <select id="create-category" name="category_id"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-100">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="create-description" name="description" rows="5"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 max-h-48 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-100 dark:placeholder-gray-400"
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="file" name="image" id="create-image"
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none dark:bg-slate-800 dark:border-slate-600 dark:text-gray-100"
                            required>
                    </div>
                    {{-- Varian Produk --}}
                    <div class="col-span-2">
            ...
            <div class="flex items-center justify-end pt-4 mt-4 space-x-2 border-t border-gray-200 dark:border-gray-600">
                ...
                <button type="button" class="js-close-modal-btn py-2.5 px-5 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700">Batal</button>
            </div>
        </div>
    </form>
</x-modal-custom>
