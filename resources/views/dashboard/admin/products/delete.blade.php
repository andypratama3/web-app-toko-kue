...
<x-modal-custom id="delete-product-modal-{{ $product->id }}" title="Konfirmasi Hapus" size="md">
    <div class="p-4 text-center md:p-5">
        ...
        <button type="button" class="js-close-modal-btn py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700">
            Tidak, batal
        </button>
    </div>
</x-modal-custom>