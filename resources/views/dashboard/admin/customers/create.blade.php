    ...
    <form class="p-4 md:p-5" action="{{ route('admin.customers.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-2">
            ...
            <div>
                ...
                <select name="added_by_user_id" id="create-added_by_user_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-100" required>
